            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-lg-6 col-xs-12">
                        <div class="quick-view-img"><img src="images/quick-view-bg.jpg" id="quickview_img" alt=""
                                class="w-100 img-fluid blur-up lazyload book-picture"></div>
                    </div>
                    <div class="col-lg-6 rtl-text">
                        <div class="product-right">
                            <h2 class="book-name">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                                Maiores,
                                distinctio.</h2>
                            ...
                            <div class="product-buttons">
                                <a href="javascript:void(0)" id="add-to-cart" data-url="" class="btn btn-solid mb-1 btn-add-to-cart">Chọn Mua</a>
                                <a href="#" data-url="" class="btn btn-solid mb-1 btn-view-book-detail">Xem chi
                                    tiết</a>
                            </div>
                        </div>
                    </div>
