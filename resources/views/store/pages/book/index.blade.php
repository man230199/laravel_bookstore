                            ...
                            <div class="row">
                                <div class="col-lg-4 col-xl-4">
                                    <div class="product-slick">
                                        <div><img src="{{ asset('store/images') }}/{{ $item['picture'] }}" alt=""
                                ...
                                <div class="col-lg-8 col-xl-8 rtl-text">
                                    <div class="product-right">
                                        ...
                                        <h4><del>{{ number_format($item['price']) }} đ</del><span>
                                                -{{ $item['sale_off'] }}%</span></h4>
                                    ...
                                    <div class="col-sm-12 col-lg-12">
                                        <ul class="nav nav-tabs nav-material" id="top-tab" role="tablist">
                                            <li class="nav-item"><a class="nav-link active" id="top-home-tab"
                                                    data-toggle="tab" href="#top-home" role="tab" aria-selected="true">Mô tả
                                                    sản phẩm</a>
                                                ...
                                                <div class="modal-bg addtocart">
                                                    ...
                                                    <div class="media">
                                                        ...
                                                        <div class="media-body align-self-center text-center">
                                                            ...
                                                            <div class="buttons">
                                                                <a href="" class="view-cart btn btn-solid">Xem giỏ hàng</a>
